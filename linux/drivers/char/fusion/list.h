...
typedef struct __D_DirectLink FusionLink;

#define fusion_list_foreach       direct_list_foreach
#define fusion_list_foreach_safe  direct_list_foreach_safe
#define fusion_list_prepend       direct_list_prepend
#define fusion_list_remove        direct_list_remove
#define fusion_list_move_to_front direct_list_move_to_front
